  ...
  return (
    <div className="pd-14 px-8 md:px-0">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        Discover the inspiring stories of our learners as they share their
        journeys of growth, achievements, <br />
        and the impact our platform has had on their lives.
      </p>
      <div className="grid grid-container gap-8 mt-14">
