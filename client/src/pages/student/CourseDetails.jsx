    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
      ...
      bg-gradient-to-b from-cyan-100/70"
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1
            className="md:course-details-heading-large
          course-details-heading-small font-semibold text-gray-800"
          >
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Batman</span>
          </p>
            ...
            <div className="pf-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul
                      className="list-disc md:pl-10 pl-4 pr-4 py-2 
        ...
        {/* Right column */}
        <div
          className="max-w-course-card z-10 shadow-custom-card
        rounded-t md:rounded-none overflow-hidden
        ...
        >
          ...
          <div className="p-5">
            ...
            md:text-default gap-4 pt-2 md:pt-4 text-gray-500"
            >
            ...
            <div className="pt-6">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                <li>
                  ...
                  <li>Step-by-step, hands-on project quidance.</li>
